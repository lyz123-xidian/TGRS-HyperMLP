...
hsi_path = '/home/sd1/liuyuzhe/TRENTO/hyper_Italy.tif'
lidar_path = '/home/sd1/liuyuzhe/TRENTO/LiDAR_Italy.tif'
...
total_trainable_params = sum(p.numel() for p in cnn.parameters() if p.requires_grad)
    ...
    for step, (b_x1, b_x2, b_x3, b_y) in enumerate(train_loader):
        ...
        if step % 50 == 0:
            ...
            for i in range(number):
                ...
                del temp, temp1, temp3#shengxia testpatch 2 de shujv
